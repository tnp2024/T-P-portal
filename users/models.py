...
class Student(models.Model):
    ...
    Live_backlogs = models.CharField(max_length=25,null=True, blank=True,choices=Boolean_choices)
    Dead_backlogs = models.CharField(max_length=25, null=True, blank=True,choices=Boolean_choices,)
    ...
    minor_projects =models.CharField(max_length= 200,null=True, blank=True)
    major_projects =models.CharField(max_length= 200,null=True, blank=True)
    Preference_1 = models.CharField(max_length=255, null=True, blank=True,choices=preferences)
    Preference_2 = models.CharField(max_length=255, null=True, blank=True,choices=preferences)
    Preference_3 = models.CharField(max_length=255, null=True, blank=True,choices=preferences)
    Placed = models.CharField(max_length =20,null=True, blank=True,choices= Boolean_choices)
