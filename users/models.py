...
class Student(models.Model):
    ...
    MOBILE_NO = models.PositiveIntegerField(default=0000000000)
    ALT_Mobile_NO = models.PositiveIntegerField(default=0000000000)
    LOCAL_ADDRS = models.CharField(max_length=255,default="current address")
    PERM_ADDRS = models.CharField(max_length=255,default='address')
    Native_Place = models.CharField(max_length=255,default='Place')
    X_Percentage = models.DecimalField(max_digits=5, decimal_places=2,default=80)
    Xth_marksheet = models.FileField(upload_to='documents/10th', null=True, blank=True)
    X_year_of_passing = models.PositiveIntegerField(default=2022)
    X_board = models.CharField(max_length=255,default='HSC')
    ...
    Admission_Type = models.CharField(max_length=255,default='Regular')
    YEAR_CHOICES = [(str(year), str(year)) for year in range(2020, 2031)]
    Pass_out_Year = models.CharField(max_length=10, choices=YEAR_CHOICES,default='2022')
    department = models.ForeignKey(Department, on_delete=models.SET_NULL, null=True)
    SEM_1_sgpa = models.DecimalField(max_digits=4, decimal_places=2,default=8)
    sem1_marksheet = models.FileField(upload_to='documents/Sem1', null=True, blank=True)
    SEM_2_sgpa = models.DecimalField(max_digits=4, decimal_places=2,default=8)
    sem2_marksheet = models.FileField(upload_to='documents/Sem2', null=True, blank=True)
    SEM_3_sgpa = models.DecimalField(max_digits=4, decimal_places=2,default=8)
    sem3_marksheet = models.FileField(upload_to='images/documents/Sem3', null=True, blank=True)
    SEM_4_sgpa = models.DecimalField(max_digits=4, decimal_places=2,default=8)
    ...
    Live_backlogs = models.CharField(max_length=25,choices=Boolean_choices,default='0')
    Dead_backlogs = models.CharField(max_length=25, choices=Boolean_choices,default='0')
    Year_gap = models.CharField(max_length=255,choices=Gap,default='no')
    Languages = models.CharField(max_length= 100,default='python')
    minor_projects =models.CharField(max_length= 200,default='projects')
    major_projects =models.CharField(max_length= 200,default='projects')
    Preference_1 = models.CharField(max_length=255,choices=preferences,default='Higher studies')
    Preference_2 = models.CharField(max_length=255,choices=preferences,default='Entreprenuership')
    Preference_3 = models.CharField(max_length=255,choices=preferences,default='Job')
