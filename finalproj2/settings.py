...
ALLOWED_HOSTS = ['t-p-portal.onrender.com','localhost:8000', '127.0.0.1']
...
EMAIL_HOST_USER = 'univplacementoffice@mgmu.ac.in'  # Your email address
EMAIL_HOST_PASSWORD =  'smzq gqdp ugws icif'
